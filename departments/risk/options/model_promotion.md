# Options Model Promotion Map

This note maps the stochastic-modelling notebooks into the production
`src/oqp/options` package and the Ops Live Portfolio Options Hub.
