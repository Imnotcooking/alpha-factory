"""Legacy pandas/hmmlearn market-regime wrappers.

This module preserves the public API shape used by research factors:
...
class MarketGMMHMM:
    ...
    def __init__(
        self, n_components=3, n_mix=2, covariance_type="diag", random_state=42
    ):
        if GMMHMM is None:
