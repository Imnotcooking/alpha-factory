...
RESEARCH_PAGE_TEXT: dict[str, dict[str, dict[str, Any]]] = {
    "adaptive_relationship_lab": {
        "en": {
            "title": "Arbitrage Lab",
            "subtitle": "Pair, calendar-spread, and cross-product dislocation analysis.",
    ...
    "alpha_feature_governance": {
        "en": {
            ...
            "subtitle": "Review feature quality, redundancy, stability, and out-of-sample importance.",
            "matrix": "Feature matrix",
            "target": "Target column",
            "include_prob": "Include regime probability columns",
            ...
            "4. VQ-VAE path: the discrete nonlinear encoder lives in "
            "`latent_engine/vqvae_feature_encoder.py`, with the plain VAE kept only "
            "as a baseline scaffold.\n"
            ...
            "mda_title": "Purged K-Fold Mean Decrease Accuracy",
            "mda_help": "\n"
            ...
            "latent_title": "STORM-style VQ-VAE Latent Cross-Check",
            "latent_help": "\n"
        ...
        "zh": {
            "page_title": "特征审查",
            "subtitle": "审查特征质量、冗余、稳定性和样本外重要性。",
            "matrix": "特征矩阵文件",
            "target": "目标列",
            "include_prob": "包含状态概率列",
            ...
            "4. VQ-VAE 路径：离散非线性编码器已经放在 `latent_engine/vqvae_feature_encoder.py`，普通 "
            "VAE 只保留为基线骨架。\n"
            ...
            "mda_title": "Purged K-Fold 平均准确率下降 MDA",
            "mda_help": "\n"
            ...
            "shortlist": "建议保留的代表特征",
            "comparison": "研究比较协议",
            "latent_title": "STORM 风格 VQ-VAE 潜变量交叉验证",
            "latent_help": "\n"
