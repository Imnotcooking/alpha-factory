...
from oqp.accounts import default_account_ledger_path
from oqp.ops.notifications import discord_field, post_json_webhook
from oqp.paper_trading import default_paper_trading_ledger_path
...
def _post_webhook(url: str, payload: dict[str, Any]) -> None:
    post_json_webhook(
        ...
        user_agent="OQP-Paper-Trading-Health/1.0",
        label="webhook  Could not post paper status:",
    )
