...
from oqp.ops.notifications import discord_field, post_json_webhook  # noqa: E402
...
def _post_discord(payload: dict[str, Any]) -> None:
    ...
    post_json_webhook(
        ...
        user_agent="OQP-Paper-Execution-Review/1.0",
        label="discord  Could not post paper review:",
    )
