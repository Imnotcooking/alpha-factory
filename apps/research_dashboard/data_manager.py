    ...
    def get_all_runs(self) -> pd.DataFrame:
        ...
        query = f"""
            SELECT r.run_id, r.factor_id, f.name, f.category AS factor_category,
                   ...
                   {run_col("crisis_rows")},
                   {run_col("raw_event_count")},
                   {run_col("quality_event_count")},
                   {run_col("throttled_event_count")},
                   {run_col("active_tick_count")},
        ...
        expected_cols = [
            ...
            "crisis_rows", "raw_event_count", "quality_event_count", "throttled_event_count",
