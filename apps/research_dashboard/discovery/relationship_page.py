...
from departments.research.workflows.statistical_arbitrage.opportunity_scan import (
    ARBITRAGE_CALENDAR,
...
from departments.research.workflows.statistical_arbitrage.relationship_dkf import (
    RelationshipLabConfig,
    run_relationship_dkf,
)
from apps.research_dashboard.arbitrage_lab.backtest_preview import (
    latest_spread_summary,
    simple_spread_backtest,
)
from apps.research_dashboard.arbitrage_lab.relationship_data import list_daily_price_files
...
if not EMBEDDED:
    st.set_page_config(page_title="Relationship Scan", layout="wide")
