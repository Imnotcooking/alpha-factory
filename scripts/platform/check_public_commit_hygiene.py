...
PRIVATE_RULES = (
    ...
    Rule(
        "departments/research/archive/**",
        "private research archive",
    ),
    Rule(
        "departments/research/routers/**",
        "private router and state registry",
    ),
    Rule(
        "departments/research/position_policies/**",
        "private position-policy registry",
    ),
    Rule(
        "departments/research/strategy_overlays/**",
        "private strategy-overlay registry",
    ),
    Rule(
        "departments/research/strategies/**",
        "private sleeve and strategy recipes",
    ),
    Rule(
        "departments/research/optimization_studies/**",
        "private optimization study definition",
    ),
    Rule(
        "departments/research/docs/factor_library/**",
        "private factor evidence note",
    ),
    Rule(
        "departments/research/docs/intraday_cn_futures/**",
        "private intraday research note",
    ),
    Rule(
        "departments/research/docs/migration/**",
        "private migration workbench note",
    ),
    Rule(
        "departments/research/docs/governance/factor_library_cleanup_status.md",
        "private factor performance inventory",
    ),
    Rule(
        "departments/research/docs/governance/factor_normalization_batches.md",
        "private factor normalization evidence",
    ),
    Rule(
        "departments/research/diagnostics/**",
        "private diagnostic implementation",
    ),
    Rule(
        "departments/research/workflows/**",
        "private research workflow implementation",
    ),
    Rule("scripts/research/experiments/**", "private research experiment"),
    Rule(
        "scripts/research/import_gtja_alpha191.py",
        "private licensed-factor import workflow",
    ),
    Rule(
        "scripts/research/run_daily_cn_futures_factor_dedup.py",
        "private factor comparison workflow",
    ),
    Rule(
        "scripts/research/run_daily_factor_screening.py",
        "private factor screening workflow",
    ),
    Rule(
        "scripts/research/run_daily_reversal_candidate_audit.py",
        "private factor candidate workflow",
    ),
    Rule(
        "scripts/research/run_intraday_cn_futures_factor_dedup.py",
        "private factor comparison workflow",
    ),
    Rule(
        "scripts/research/run_phase8_factor_optimization.py",
        "private factor optimization workflow",
    ),
    Rule(
        "notebooks/Phase_7_Research_Projects/*_private/**",
        "private research project",
    ),
    Rule("reports/**", "generated report artifact"),
    Rule("output/**", "generated output artifact"),
...
PUBLIC_BOUNDARY_EXCEPTIONS = {
    ...
    "departments/research/routers/README.md",
    "departments/research/routers/router_template_private.py",
    "departments/research/position_policies/README.md",
    "departments/research/strategy_overlays/README.md",
    "departments/research/strategy_overlays/overlay_template_private.py",
    "departments/research/strategies/README.md",
    "departments/research/strategies/sleeves/README.md",
    "departments/research/diagnostics/README.md",
    "departments/research/workflows/README.md",
}
